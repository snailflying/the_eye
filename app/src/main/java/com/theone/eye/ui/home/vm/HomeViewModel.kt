...
import com.theone.eye.ui.home.adapter.HomeBannerBinder
import com.theone.eye.ui.home.adapter.HomeOnePlusThreeBinder
import com.theone.eye.ui.home.adapter.HomeOneReportBinder
import com.theone.eye.ui.home.entity.FloorItemDemo
import com.theone.eye.ui.home.entity.FloorTypeConstants
import com.theone.eye.ui.home.model.HomeModel
import com.theone.eye.ui.home.model.IHomeModel
...
//            itemsFloor.add(HomeTitleOneEn(floorBean))
    ...
    private fun addRoomTypes(floorBean: FloorItemDemo?) {
        ...
        when {
            ...
            curRoom.isOneReport -> {
                topFloorItemType = FloorTypeConstants.ROOM_ONE_REPORT
                itemsFloor.add(HomeOneReportBinder.HomeOneData(floorBean))
            }
        }
    }
}